...
public class RemarkCommandTest {
    private static final String REMARK_STUB = "mock remark";
    private Model model = new ModelManager(getTypicalAddressBook(), new UserPrefs());

    @Test
    public void execute_addRemark_UnfilteredList_success() {
    ...
    @Test
    public void execute_deleteRemark_UnfilteredList_success() {
        Person firstPerson = model.getFilteredPersonList().get(INDEX_FIRST_PERSON.getZeroBased());
    ...
    @Test
    public void execute_addRemark_filteredList_success() {
